...
export class Hour1400Service {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiHour1400UploadPost(request?: Hour1400UploadRequest, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiHour1400UploadPost(request?: Hour1400UploadRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiHour1400UploadPost(request?: Hour1400UploadRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiHour1400UploadPost(request?: Hour1400UploadRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
